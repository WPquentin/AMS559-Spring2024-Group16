...
def compute_boundary_condition(c_s, k = 1.0, F = 1.0, D_s = 1.0):
...
def main(L=1.0, N=60, t_tot=60.0, nt=60, q_max=4.0):
    ...
    for i in range(nt):
        ...
        q_new_BE = dif.SolveDiffusionEquation(q_old_BE, bc_old_BE, bc_new_BE,
            D_s, dt, h, L, theta = 1.0) # Backward-Euler (BE)
        print("difference between bc_new_CN and bc_new_CN:", bc_new_CN- bc_old_CN)
