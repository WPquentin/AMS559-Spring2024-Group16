...
from neuralop.datasets import load_darcy_flow_small, load_burgers, load_diffusion_pt
...
data_path = 'C:\\Users\\jizhang\\Desktop\\projects\\ai4science\\electrochemistry\\NumericalDiffusionScheme-master\\Code_radial_normlized\\data_dict_constBC_00.pickle'
# %%
...
wandb_log = False
if wandb_log:
    wandb.init(project = "operator_diffusion", name = datetime.datetime.now().strftime("%Y%m%d%H%M"))
